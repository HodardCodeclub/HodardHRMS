...
function validation()
{
	...
	else if(frmchange.oldpass.value.length<6 || frmchange.oldpass.value.length>15)
	{
		alert("Old password should be greater than 6 character and less than 15 characters...");
		frmchange.oldpass.focus();
		return false;
	}
