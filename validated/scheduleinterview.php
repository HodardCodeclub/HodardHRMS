...
function validation()
{
	if(frmsch.selectionround.value=="")
	{	
		alert("Selection round should not be empty...");	
		frmsch.selectionround.focus();
		return false;
	}
	else if(frmsch.fromdate.value=="")
	{
		alert("From date should not be empty...");
		frmsch.fromdate.focus();
		return false;
	}
	else if(frmsch.fromtime.value=="")
	{
		alert("From time should not be empty...");
		frmsch.fromtime.focus();
		return false;
	}
	else if(frmsch.todate.value=="")
	{
		alert("To date should not be empty...");
		frmsch.todate.focus();
		return false;
	}
	else if(frmsch.totime.value=="")
	{
		alert("To time should not be empty...");
		frmsch.totime.focus();
		return false;
	}
	else if(frmsch.ven.value=="")
	{
		alert("Venue should not be empty...");
		frmsch.ven.focus();
		return false;
	}
	else if(isNaN(frmsch.cno.value==""))
	{
		alert("Contact number should not be empty...");
		frmsch.cno.focus();
		return false;
	}
	else if(isNaN(frmsch.cno.value.length  != 10))
	{		
		alert("Invalid mobile number.. ");
		frmsch.cno.focus();
		return false;
	}
	else if(frmsch.stat.value=="")
	{
		alert("Kindly select the sataus...");
		frmsch.stat.focus();
		return false;
	}
	else
...
?>
    <div id="templatemo_main">
        ...
        <div id="templatemo_content">
            ...
            <p>
<form name=frmsch method="post" action=""onsubmit="return validation()">
